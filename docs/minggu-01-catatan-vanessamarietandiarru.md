...
| 4 | Ubah ```APP_DEBUG=false```, lalu ulangi nomor 3 | Akan tetap error | "505 Server Error", yang berarti server tidak mendukung versi protokol HTTP yang digunakan oleh _browser_. |
